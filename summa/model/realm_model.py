...
from summa import get_args, print_rank_0
from summa.checkpointing import get_checkpoint_tracker_filename, get_checkpoint_name
...
from summa.model.language_model import get_language_model
from summa.model.utils import scaled_init_method_normal
from summa.model.bert_model import bert_attention_mask_func, bert_extended_attention_mask, bert_position_ids
...
class ICTBertModel(OptimusModule):
...
class IREncoderBertModel(OptimusModule):
