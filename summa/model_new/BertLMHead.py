...
class DENSE(torch.autograd.Function):
    ...
    def forward(ctx, A, B, C_shape, row_rank, col_rank,
        ...
        forward_buffer = mpu.get_fhh_forward_buffer()
